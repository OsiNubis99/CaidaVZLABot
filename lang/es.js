...
module.exports = {
  ...
  only_admin_all_cpu: "Solo @OsiNubis99 puede correr partidas de solo BOTS.",
  ...
  mata_mesa_msg: "🔄 Mata mesa: -{n} pts al dealer\n",
  mesa_win_pending:
  ...
  // ─── In-game render strings (used by class/Game.js print helpers) ───
  ig_last_hand: "✨ Última mano\n",
  ig_mesa_label: "Mesa:",
  ig_empty_slot: " []",
  ig_last_card_label: "🎴 Última carta: ",
  ig_card_of: " de ",
  ig_next_label: "👉 Turno: ",
  ig_team_label: "Equipo ",
  ig_team_red: "Rojo",
  ig_team_blue: "Azul",
  ig_team_red_emoji: "🔴 ",
  ig_team_blue_emoji: "🔵 ",
  ig_pts_suffix: " pts",
  ig_took_suffix: " tomadas",
  ig_cards_suffix: " cartas",
  ig_sang_prefix: "cantó ",
  ig_no_sang: "sin canto",
  ig_player_bullet: "   • ",
  ig_dot_sep: " · ",
