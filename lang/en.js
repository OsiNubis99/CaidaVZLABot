...
module.exports = {
  ...
  only_admin_all_cpu: "Only @OsiNubis99 can run BOT-only games.",
  ...
  salir_bot_running:
    "Game already started. Bots can't be removed now — wait for it to end or ask an admin to /reiniciar.",
