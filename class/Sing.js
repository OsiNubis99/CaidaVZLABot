	...
	constructor(word, cards) {
		if (word == null) {
			...
			if (this.word == 5 || this.word == "ronda") {
				...
				if(cards[2].position==(cards[1].position+2) && cards[1].position==(cards[0].position+2)){
					this.value = 5;
					this.name = "Chiguire"
				}
			} else if (this.word == 7 || this.word == "patrulla") {
				if(cards[2].position==(cards[1].position+1) && cards[1].position==(cards[0].position+1)){
					this.value = 6;
					this.name = "Patrulla"
				}
			} else if (this.word == 8 || this.word == "Vigía") {
				if ((cards[2].position==(cards[1].position+1) && cards[1].position==cards[0].position)||
						(cards[1].position==(cards[0].position+1) && cards[1].position==cards[2].position)){
					this.value = 7;
					this.name = "Vigía"
				}
			} else if (this.word == 9 || this.word == "registro") {
				if(cards[0].value==1 && cards[1].value==11 && cards[2].value==12){
					this.value = 8;
					this.name = "Registro"
				}
			} else if (this.word == 10 || this.word == "maguaro") {
				if(cards[0].value==1 && cards[1].value==10 && cards[2].value==12){
					this.value = 9;
					this.name = "Maguaro"
				}
				...
				if(cards[0].value==1 && cards[1].value==1 && cards[2].value==12){
					this.value = 11;
					this.name = "Casa "
				}
			} else if (this.word == 13 || this.word == "cgrande") {
				if(cards[0].value==1 && cards[1].value==12 && cards[2].value==12){
					this.value = 12;
					this.name = "Casa "
				}
